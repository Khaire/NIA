...
public class ListOfLobsFromConfig {
	public ArrayList<String> listOfLobForExe;
	private Properties prop;
	private InputStream input;

	public ListOfLobsFromConfig() {
		this.listOfLobForExe = listOfScenario(scenarioStringSplitToArray(fetchingScenarioNameFromProperties()));
	}
