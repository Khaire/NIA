...
public class ExecutionTestScenarios {
	...
	@Column(name = "executionTestScenario_Lob")
	private String executionTestScenario_Lob;
	...
	public String getExecutionTestScenario_Lob() {
		return executionTestScenario_Lob;
	}

	public void setExecutionTestScenario_Lob(String executionTestScenario_Lob) {
		this.executionTestScenario_Lob = executionTestScenario_Lob;
	}
