...
import com.aqm.staf.library.databin.IsMemPortNonNIAPolEntity;
import com.aqm.staf.library.databin.MembAtachCovrgPremSchdEntity;
import com.aqm.staf.library.databin.PolMemPreExstngDisesEntity;
import com.aqm.staf.library.databin.PolMemStrtDateForMemEntity;
import com.aqm.staf.library.databin.PolicyMemberAttributeEntity;
import com.aqm.staf.library.databin.PortabilityEntity;
...
public class PolicyMemStartDateForMember extends BasePage {
	...
	public void saveButtonIsMemberPortedFromNonNiaPolicyPage(PolMemStrtDateForMemEntity polMemStrtDateForMemEntity){
		...
		if (polMemStrtDateForMemEntity.getBooleanValueForField("ConfigSaveButton")){
			if(polMemStrtDateForMemEntity.getStringValueForField("Product").equalsIgnoreCase("JM")||polMemStrtDateForMemEntity.getStringValueForField("Product").equalsIgnoreCase("MC")|| polMemStrtDateForMemEntity.getBooleanValueForField("ConfigRenew")){
				click(saveButton);
			}
			else {
				click(forwordButton);
