...
public class ClaimChargesSubLimitsRural extends BasePage{
	...
	public void fillClaimChargesSubLimitsRural(ClaimChrgSubLimitREntity claimChrgSubLimitREntity ,CustomAssert assertReference) throws InterruptedException{
		if(claimChrgSubLimitREntity.getAction().equalsIgnoreCase("add") || claimChrgSubLimitREntity.getAction().equalsIgnoreCase("edit")){
			...
			if (claimChrgSubLimitREntity.getBooleanValueForField("ConfigNameOfTheAssessor")) {
				assertReference.assertEquals(claimChrgSubLimitREntity.getStringValueForField("NameOfTheAssessor"),fetchValueFromTextFields(NameOfTheAssessorTextField), AssertionType.WARNING);
					
			}
			
			if (claimChrgSubLimitREntity.getBooleanValueForField("ConfigIRDALicenseNo")) {
				assertReference.assertEquals(claimChrgSubLimitREntity.getStringValueForField("IRDALicenseNo"),fetchValueFromTextFields(IRDALicenseNoTextField), AssertionType.WARNING);
					
			}
			if (claimChrgSubLimitREntity.getBooleanValueForField("ConfigAddressOfTheAssessor")) {
				assertReference.assertEquals(claimChrgSubLimitREntity.getStringValueForField("AddressOfTheAssessor"),fetchValueFromTextFields(AddressOfTheAssessorTextArea), AssertionType.WARNING);
				
			}
			if (claimChrgSubLimitREntity.getBooleanValueForField("ConfigRemarksOfTheAssessor")) {
				assertReference.assertEquals(claimChrgSubLimitREntity.getStringValueForField("RemarksOfTheAssessor"),fetchValueFromTextFields(RemarksOfTheAssessorTextArea), AssertionType.WARNING);
